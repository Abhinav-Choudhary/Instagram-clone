    ...
    <head>
        ...
        <style>
            ...
            .image-overlay {
                ...
                justify-content: center;
                opacity: 0;
                background: rgba(0, 0, 0, 0.7); /* Adjust the darkness of the overlay */
                color: white;
                ...
                <div class="col-9 scrollable-col">
                    <div class="row mt-3 border-bottom">
                        <div class="col-4 profile-pic-container">
                            <img src="/users/${sessionScope.currentUser.username}.jpg"
                                    alt="Profile Picture" 
                                    width="100%" 
                        ...
                        <div class="col-8">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col">
                                    <strong>174 Followers</strong>
                                </div>
                                <div class="col">
                                    <strong>222 Following</strong>
                                </div>
                            </div>
                            <div class="row mt-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mt-3">
                            <c:forEach items="${profilePosts}" var="post">
                                <div class="col-4 p-2 image-container">
                                    <a href="post_${post.id}">
                                        <img
                                        src="/posts/${sessionScope.currentUser.username}${post.id}.jpg"
                                        alt="Profile Post"
                                        width="100%">
